<?php
/**
Plugin Name: VC Super Bundle
Description: A super bundle of different addons to get the most out of Visual Composer
...
defined( 'VERSION_GAMBIT_VC_SUPER_BUNDLE' ) || define( 'VERSION_GAMBIT_VC_SUPER_BUNDLE', '1.2.2' );
...
if ( ! class_exists( 'VC_Super_Bundle' ) ) {
	...
	class VC_Super_Bundle {
		...
		public function render_settings_page() {
			...
			<p>
				<?php esc_html_e( 'Super bundle contains a lot of awesome elements and addons for Visual Composer. You can enable/disable the different elements and features here.', 'super-bundle' ) ?>
			</p>
			<div class="card">
