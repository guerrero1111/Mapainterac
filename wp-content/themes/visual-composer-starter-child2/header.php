...
$.src="https://v2.zopim.com/?5xHfafssp3QsBcK6mcwgmzeDiVm37u57";z.t=+new Date;$.
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-121558792-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-121558792-1');
</script>
</head>
<body>
...
<span style="width: 100%;
    display: inline-block;"><i class="fa fa-window-close" aria-hidden="true" style="float: left;margin: 4px;"></i>Tipos de cambio</span>
<?php } ?>
